...
//구조체(struct)
//여러 자료형의 변수들을 하나로 묶어서 새로운 자료형으호 만드는 것을 의미합니다.(복합 자료형)
//사용자의 편의대로 묶어서 하나의 형태로 표현사는 방식이기에 사용자 정의 타입이라고도 부릅니다.
...
//구조체 선언은 변수 선언이 아니기 때문에, 사용하기 위해서 따로 변수 선언과 초기화를 진행해야 합니다.


int main()
{
	//구조체 변수 및 초기화방법
	//struct 구조체명 변수명= { 구조체의 정의된 변수 순서대로 값을 작성합니다.};
